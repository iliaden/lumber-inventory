...
public abstract interface LumberApiService {
    ...
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getSpecies(@org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.lumber.inventory.data.model.ApiResponse<java.util.List<java.lang.String>>>> $completion);
    ...
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.lumber.inventory.data.model.ApiResponse<java.util.List<com.lumber.inventory.data.model.Tag>>>> $completion);
    
    @retrofit2.http.GET(value = "tags/{id}")
    @org.jetbrains.annotations.Nullable()
    public abstract java.lang.Object getTag(@retrofit2.http.Path(value = "id")
    int id, @org.jetbrains.annotations.NotNull()
    kotlin.coroutines.Continuation<? super retrofit2.Response<com.lumber.inventory.data.model.ApiResponse<com.lumber.inventory.data.model.Tag>>> $completion);
